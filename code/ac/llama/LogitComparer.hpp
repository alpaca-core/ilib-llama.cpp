...
public:
    ...
    bool compare(const ProbVector& logit1, const ProbVector& logit2, size_t size) {
        ...
        printTheRest(logit1, "70b");
        printTheRest(logit2, "8b");
